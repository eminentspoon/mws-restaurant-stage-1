...
The full report for accessibilty targets can be found [here](), this also includes screenshots of the achieved targets.

#### Progressive Web Application

The full report for progressive web application targets can be found [here](), this also includes screenshots of the achieved targets.
...
The full report for the performance targets can be found [here](), this also includes screenshots of the targets under different scenarios.
